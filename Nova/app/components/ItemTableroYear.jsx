...
export default function ItemTableroYear({ title, span, icon, before, after }) {
      ...
      <View style={styles.dataContainer}>
        ...
        <View style={styles.comparationData}>
          <View style={styles.dataBefore}>
            <Text style={styles.comparationTitle}>Año ant.:</Text>
            <Text
              style={[
          ...
          <View style={styles.dataAfter}>
            <Text style={styles.comparationTitle}>Este año:</Text>
            <Text
              style={[
                styles.comparationNumber,
